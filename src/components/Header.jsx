function Header(){
    return (
        <nav className="flex flex-row justify-between px-4 py-4 items-center">
            <h2 className="font-fraunces text-3xl italic font-medium">Bingr<span className="text-accent ">.</span></h2>
            <button className="flex flex-row gap-1 items-center px-6 py-3 text-sm text-bg-1 bg-ink rounded-4xl border-none cursor-pointer hover:bg-accent hover:text-ink">
